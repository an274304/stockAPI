...
{
    public class VendorBillTableRepo : IVendorBillTableRepo
    {
        private string _connectionString;
        public VendorBillTableRepo(ApplicationDbContext context)
        {
        ...
        public List<PurchaseOrder> GetApprovedBillAtDirector()
        {
            ...
            {
                using (var cmd = new SqlCommand("GetApprovedBillAtDirector", conn))
                {
        ...
        public List<PurchaseOrder> GetPendingBillAtDirector()
        {
            ...
            using (var conn = new SqlConnection(_connectionString))
            {
                using (var cmd = new SqlCommand("GetPendingBillAtDirector", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    conn.Open();
        ...
        public List<PurchaseOrder> GetRejectedBillAtDirector()
        {
            ...
            using (var conn = new SqlConnection(_connectionString))
            {
                using (var cmd = new SqlCommand("GetRejectedBillAtDirector", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    conn.Open();
